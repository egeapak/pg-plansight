...
/// Split a log line into its leading timestamp (capture group 1) and the
/// remaining message (group 2), equivalent to capturing with
/// [`RegexPatterns::log_line_regex`] ([`LOG_LINE_PATTERN`]) but skipping the
/// regex entirely for the overwhelmingly common continuation lines.
///
