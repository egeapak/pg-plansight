        ...
        match key {
            ...
            "Workers Planned" => {
                if let Ok(workers) = value.parse::<u32>() {
                    ...
                    PlanProperty::Custom { key: key.to_string(), value: value.to_string() }
                }
            }
            "Workers Launched" => {
                if let Ok(workers) = value.parse::<u32>() {
            ...
            "Inner Unique" => {
                match value.to_lowercase().as_str() {
                    ...
                    _ => PlanProperty::Custom { key: key.to_string(), value: value.to_string() }
                }
            }
...
mod tests {
    ...
    fn test_custom_properties() {
        ...
        assert_eq!(props.get("Custom Property"), Some("custom value".to_string()));
